...
def defence(char_name: str, char_class: str) -> str:
    """Функция для полечения очков защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Получение специального умения для выбранного героя."""
    if char_class == 'warrior':
        return (
...
if __name__ == '__main__':
    ...
    print(start_training(char_name, char_class))x
